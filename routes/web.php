...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::post('blood-tests', StoreBloodTestController::class)
        ->middleware('throttle:lab-pdf-uploads')
        ->name('blood-tests.store');
    ...
    Route::delete('blood-tests/{bloodTest}', DestroyBloodTestController::class)
        ->middleware('throttle:health-data-mutations')
        ->name('blood-tests.destroy');
    ...
    Route::delete('context-notes/{contextNote}', DestroyContextNoteController::class)
        ->middleware('throttle:health-data-mutations')
        ->name('context-notes.destroy');
    ...
    Route::delete('reminders/{reminder}', DestroyReminderController::class)
        ->middleware('throttle:health-data-mutations')
        ->name('reminders.destroy');

    Route::match(['get', 'post'], 'consult-overview', ShowConsultOverviewController::class)->name('consult-overview.index');
    Route::post('consult-overview.csv', ExportConsultOverviewCsvController::class)
        ->middleware('throttle:health-data-exports')
        ->name('consult-overview.csv');
    ...
    Route::delete('biomarkers/{biomarker}/pin', UnpinBiomarkerController::class)
        ->middleware('throttle:health-data-mutations')
        ->name('biomarkers.unpin');
});
