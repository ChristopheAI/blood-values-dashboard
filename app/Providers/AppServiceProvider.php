...
class AppServiceProvider extends ServiceProvider
{
    ...
    protected function configureDefaults(): void
    {
        ...
        // Behind Railway's TLS-terminating edge the app is reached over https
        // while the container speaks http. Force every generated URL (assets,
        // redirects, paginator, Livewire endpoints) to https in production so
        // browsers do not block them as mixed content.
        if (app()->isProduction()) {
