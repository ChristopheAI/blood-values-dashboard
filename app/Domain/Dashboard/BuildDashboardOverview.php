        ...
        return [
            ...
            'workstand' => collect([
                ...
                [
                    ...
                    'help' => 'Deze waarden tellen mee in status, trends en consultlijst.',
                    'emphasis' => false,
                    'icon' => 'check-badge',
                    'tone' => 'amber',
                ],
                [
                    ...
                    'summary' => $this->countLabel($reviewDraftCount, 'waarde na te kijken', 'waarden na te kijken'),
                    'help' => 'Deze waarden tellen pas mee nadat je ze bevestigd hebt.',
