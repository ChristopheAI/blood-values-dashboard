...
class DashboardTest extends TestCase
{
    ...
    public function test_dashboard_prompts_review_when_owned_extracted_drafts_remain(): void
    {
        ...
        $this->actingAs($user)
            ...
            ->assertOk()
            ->assertSee('data-test="dashboard-next-step"', false)
            ->assertSee('Eerst review afronden')
    ...
    public function test_dashboard_workstand_summarizes_owned_follow_up_state(): void
    {
        ...
        $this->actingAs($user)
            ->get(route('dashboard'))
            ->assertOk()
            ->assertSee('data-test="dashboard-metrics"', false)
            ->assertSee('data-test="dashboard-metric-blood-tests"', false)
            ->assertSee('data-test="dashboard-metric-confirmed"', false)
            ->assertSee('data-test="dashboard-metric-review"', false)
