...
it('builds a print ready consult pack from selected owned confirmed values and source documents', function () {
    ...
    $response = $this->actingAs($user)
        ...
        ->assertSeeInOrder(['1 juni 2026', 'Ferritin', '55 ug/L', 'high', 'Bron: June test', 'Bevestigd: 2 juni 2026'])
        ->assertSee('+13 ug/L')
        ->assertSeeInOrder(['Hemoglobin', '1 juli 2026', 'Bron: July test', 'Bevestigd: 2 juli 2026', '14 g/dL', 'normal'])
